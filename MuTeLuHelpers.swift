...
let dailyFortuneData: [DailyFortuneSet] = [
    DailyFortuneSet(
        ...
        goodColor: "แดง",
        goodColorEN: "Red",
        badColor: "ฟ้า/น้ำเงิน",
        badColorEN: "Light Blue / Blue",
        templeNameTH: "วัดพระแก้ว",
        templeNameEN: "Wat Phra Kaew",
    ...
    DailyFortuneSet(
        ...
        badColor: "แดง",
        badColorEN: "Red",
        templeNameTH: "วัดอรุณ",
        templeNameEN: "Wat Arun",
    ...
    DailyFortuneSet(
        ...
        badColor: "เหลือง",
        badColorEN: "Yellow",
        templeNameTH: "วัดโพธิ์",
        templeNameEN: "Wat Pho",
    ...
    DailyFortuneSet(
        ...
        badColor: "ม่วง",
        badColorEN: "Purple",
        templeNameTH: "วัดสระเกศ",
        templeNameEN: "Wat Saket",
    ...
    DailyFortuneSet(
        ...
        goodColor: "ฟ้า/น้ำเงินอ่อน",
        goodColorEN: "Light Blue",
        badColor: "ดำ",
        badColorEN: "Black",
        templeNameTH: "วัดเทพธิดาราม",
        templeNameEN: "Wat Thepthidaram",
    ...
    DailyFortuneSet(
        ...
        goodColor: "ม่วง/ดำ",
        goodColorEN: "Purple / Black",
        badColor: "เขียว",
        badColorEN: "Green",
        templeNameTH: "วัดอัปสรสวรรค์",
        templeNameEN: "Wat Apsornsawan",
...
func getDailyFortuneSet(for member: Member?) -> DailyFortuneSet {
    ...
    return dailyFortuneData.first { $0.weekday == weekday }!
}
